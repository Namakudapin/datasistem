...
const HomePage = () => {
  ...
  return (
    <div className="bg-[#f4f8ff] min-h-screen p-6 pt-16 overflow-x-hidden overflow-y-auto sm:px-6 lg:px-8">
  <div className="max-w-6xl mx-auto">
    ...
    <div className="flex justify-between items-center">
      <h1 className="mt-6 text-black font-bold text-3xl">Project</h1>
      <a
